...
-- Using DELETE instead of TRUNCATE so FK checks stay off across all statements
DELETE FROM audit_logs;
DELETE FROM support_messages;
DELETE FROM lock_access_logs;
...
ALTER TABLE platform_admins AUTO_INCREMENT = 1;
...
ALTER TABLE tenancies      AUTO_INCREMENT = 1;
ALTER TABLE invoices       AUTO_INCREMENT = 1;
ALTER TABLE invoice_items  AUTO_INCREMENT = 1;
ALTER TABLE payments       AUTO_INCREMENT = 1;
ALTER TABLE utility_rates  AUTO_INCREMENT = 1;
ALTER TABLE utility_readings AUTO_INCREMENT = 1;
ALTER TABLE owner_payouts  AUTO_INCREMENT = 1;
ALTER TABLE maintenance_tickets AUTO_INCREMENT = 1;
ALTER TABLE smart_locks    AUTO_INCREMENT = 1;
ALTER TABLE lock_access_logs AUTO_INCREMENT = 1;
