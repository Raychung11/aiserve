...
$sql = "SELECT * FROM ai_cs_showcases WHERE 1=1";
$params = [];

if ($q !== '') {
    $sql .= " AND (title LIKE ? OR company_name LIKE ? OR category LIKE ? OR short_description LIKE ?)";
    $like = '%' . $q . '%';
    $params[] = $like;
    $params[] = $like;
    $params[] = $like;
...
admin_header('AI Customer Service Builder');
?>

<div class="card">
    <div style="display:flex;justify-content:space-between;gap:16px;align-items:flex-start;flex-wrap:wrap;">
        <div>
            <h3 style="margin:0;">AI Customer Service Builder</h3>
            <p class="muted" style="margin:6px 0 0;">Manage client showcases, descriptions, images, and featured use cases for the public page.</p>
        </div>
        <a href="/admin/ai_cs_showcase_edit.php" class="btn">Add Showcase</a>
    </div>
</div>
...
<div class="card" style="margin-top:20px;">
    <form method="get">
        <div class="form-grid">
            <div class="field">
                <label>Search</label>
                <input type="text" name="q" value="<?= h($q) ?>" placeholder="Search title, company, category">
            </div>
            <div class="field">
                <label>Status</label>
                <select name="status">
            ...
            <div class="field" style="align-self:end;">
                <div style="display:flex;gap:10px;flex-wrap:wrap;">
                    ...
                    <a href="/admin/ai_cs_showcases.php" class="btn-secondary">Reset</a>
                </div>
            </div>
        </div>
    </form>
...
<div class="card" style="margin-top:20px;">
    <div class="table-wrap">
        <table class="desktop-table">
            ...
            <tbody>
            <?php if (!$rows): ?>
                <tr><td colspan="7">No showcase items yet.</td></tr>
            <?php else: ?>
                <?php foreach ($rows as $r): ?>
                    <tr>
                        ...
                        <td><a href="/admin/ai_cs_showcase_edit.php?id=<?= (int)$r['id'] ?>">Edit</a></td>
                    </tr>
                <?php endforeach; ?>
            <?php endif; ?>
            </tbody>
