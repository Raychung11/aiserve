  ...
  <div class="container">
    <div class="row g-4">
      ...
      <div class="col-lg-4">
        ...
        <p class="text-muted small"><?= t('footer_tagline') ?></p>
        <p class="text-muted small"><?= t('footer_operated') ?></p>
        <div class="d-flex gap-3 mt-3">
          <a href="#" class="text-muted footer-social"><i class="bi bi-facebook fs-5"></i></a>
          <a href="#" class="text-muted footer-social"><i class="bi bi-linkedin fs-5"></i></a>
          <a href="#" class="text-muted footer-social"><i class="bi bi-whatsapp fs-5"></i></a>
          <a href="#" class="text-muted footer-social"><i class="bi bi-wechat fs-5"></i></a>
        </div>
      </div>
      ...
      <div class="col-lg-4">
        ...
        <p class="text-muted small mb-1"><i class="bi bi-envelope me-2"></i><?= h(get_setting('site_email', 'info@mm2h.com')) ?></p>
        <p class="text-muted small mb-1"><i class="bi bi-telephone me-2"></i><?= h(get_setting('site_phone', '+60 3-XXXX XXXX')) ?></p>
        <p class="text-muted small"><i class="bi bi-geo-alt me-2"></i>Kuala Lumpur, Malaysia</p>
      </div>
    </div>
    ...
    <div class="footer-disclaimer">
      <p class="text-muted small mb-2"><strong><?= t('warning') ?>:</strong> <?= t('disclaimer') ?></p>
    </div>

    <div class="row align-items-center">
      <div class="col-md-6">
        <p class="text-muted small mb-0">&copy; <?= date('Y') ?> MM2H 管家. <?= t('footer_rights') ?></p>
      </div>
