...
class ReportGenerator {
    ...
    private static function buildReportHTML(array $company, string $framework, string $frameworkLabel,
        ...
        // Cover page
        $ob .= '<div class="cover">';
        $ob .= '<div class="cover-logo">AiServe ESG OS</div>';
        $ob .= '<h1>' . $name . '</h1>';
        ...
        $ob .= '<p>This report was generated by <strong>AiServe ESG OS</strong> on ' . $generated . '.</p>';
        ...
        $ob .= '<p style="color:#16a34a">AiServe ESG OS — Automate compliance, secure supply chains, and unlock financing.</p>';
        $ob .= '</div>';
        $ob .= '</body></html>';
